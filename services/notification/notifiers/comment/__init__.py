    ...
    def _create_upgrade_message(self, comparison):
        ...
        if not requires_license():
            return [
                ...
                f"Please [activate this user on Codecov]({links['members_url']}) to display this PR comment.",
            ...
            return [
                ...
                f"Please [activate this user]({links['members_url']}) to display this PR comment.",

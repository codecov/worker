...
class TestCommentNotifierIntegration(object):
    ...
    async def test_notify_gitlab(self, sample_comparison_gitlab, codecov_vcr):
        ...
        message = [
            ...
            "Base: **50.00**% // Head: **60.00**% // Increases project coverage by **`+10.00%`** :tada:",
            "> Coverage data is based on head [(`46ce216`)](None/gl/l00p_group_1:subgroup1/proj-b/pull/11?src=pr&el=desc) compared to base [(`842f7c8`)](None/gl/l00p_group_1:subgroup1/proj-b/commit/842f7c86a5d383fee0ece8cf2a97a1d8cdfeb7d4?el=desc).",
            "> Patch has no changes to coverable lines.",
            "",

...
class TestIRCNotifier(object):
    ...
    def test_send_actual_notification(self, dbsession, mock_configuration, sample_comparison, mocker):
        mocked_connection = mocker.patch('services.notification.notifiers.irc.socket.socket').return_value

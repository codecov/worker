            ...
            "output": {
                ...
                "text": "\n".join(
                    [
                        ...
                        "",
                        f"| [Files with reduced coverage](codecov.io/gh/test_build_default_payload/{repo.name}/pull/{sample_comparison.pull.pullid}?src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
                        "|---|---|---|---|",
            ...
            "output": {
                ...
                "text": "\n".join(
                    [
                        ...
                        "> The diff coverage is `66.67%`.",
                        "",
                        f"| [Files with reduced coverage](codecov.io/gh/test_build_default_payload/{repo.name}/pull/{sample_comparison.pull.pullid}?src=pr&el=tree&utm_medium=referral&utm_source=github&utm_content=checks&utm_campaign=pr+comments&utm_term={quote_plus(repo.owner.name)}) | Coverage Δ | Complexity Δ | |",
                        "|---|---|---|---|",
            ...
            "output": {
                ...
                "text": "\n".join(
                    [
                        ...
                        f"",
                        "",
                        f"| [Files with reduced coverage](test.example.br/gh/test_build_default_payload/{repo.name}/pull/{sample_comparison.pull.pullid}?dropdown=coverage&src=pr&el=tree) | Patch % | Lines |",
                        "|---|---|---|",
                        ...
                        "",
                        f"| [Files with reduced coverage](test.example.br/gh/test_build_default_payload/{repo.name}/pull/{sample_comparison.pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
                        "|---|---|---|---|",
            ...
            "output": {
                ...
                "text": "\n".join(
                    [
                        ...
                        f"",
                        "",
                        f"| [Files with reduced coverage](test.example.br/gh/test_build_default_payload_with_flags/{repo.name}/pull/{sample_comparison.pull.pullid}?dropdown=coverage&src=pr&el=tree) | Patch % | Lines |",
                        "|---|---|---|",
                        ...
                        "",
                        f"| [Files with reduced coverage](test.example.br/gh/test_build_default_payload_with_flags/{repo.name}/pull/{sample_comparison.pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
                        "|---|---|---|---|",
            ...
            "output": {
                ...
                "text": "\n".join(
                    [
                        ...
                        "",
                        f"| [Files with reduced coverage](test.example.br/gh/{test_name}/{repo.name}/pull/{sample_comparison.pull.pullid}?dropdown=coverage&src=pr&el=tree) | Patch % | Lines |",
                        "|---|---|---|",
                        ...
                        "",
                        f"| [Files with reduced coverage](test.example.br/gh/{test_name}/{repo.name}/pull/{sample_comparison.pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
                        "|---|---|---|---|",

...
class TestCommentNotifier(object):
    ...
    async def test_create_message_files_section(
        ...
        expected_result = [
            ...
            "",
            f"| [Files with reduced coverage](https://app.codecov.io/gh/{repository.slug}/pull/{pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
            "|---|---|---|---|",
    ...
    async def test_build_message(
        ...
        expected_result = [
            ...
            "",
            f"| [Files with reduced coverage](test.example.br/gh/{repository.slug}/pull/{pull.pullid}?dropdown=coverage&src=pr&el=tree) | Patch % | Lines |",
            "|---|---|---|",
            ...
            "",
            f"| [Files with reduced coverage](test.example.br/gh/{repository.slug}/pull/{pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
            "|---|---|---|---|",
    ...
    async def test_build_message_hide_complexity(
        ...
        expected_result = [
            ...
            "Flags with carried forward coverage won't be shown. [Click here](https://docs.codecov.io/docs/carryforward-flags#carryforward-flags-in-the-pull-request-comment) to find out more.",
            "",
            f"| [Files with reduced coverage](test.example.br/gh/{repository.slug}/pull/{pull.pullid}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | |",
            "|---|---|---|",
...
class TestFileSectionWriter(object):
    ...
    async def test_filesection_no_extra_settings(self, sample_comparison, mocker):
        ...
        assert lines == [
            "| [Files with reduced coverage](pull.link?dropdown=coverage&src=pr&el=tree) | Coverage Δ | |",
            "|---|---|---|",
    ...
    async def test_filesection_hide_project_cov(self, sample_comparison, mocker):
        ...
        assert lines == [
            "| [Files with reduced coverage](pull.link?dropdown=coverage&src=pr&el=tree) | Patch % | Lines |",
            "|---|---|---|",
...
class TestCommentNotifierInNewLayout(object):
    ...
    async def test_build_message_no_project_coverage(
        ...
        expected_result = [
            ...
            "Attention: Patch coverage is `66.66667%` with `1 line` in your changes missing coverage. Please review.",
            "",
            f"| [Files with reduced coverage]({pull_url}?dropdown=coverage&src=pr&el=tree) | Patch % | Lines |",
            "|---|---|---|",
    ...
    async def test_build_message_no_project_coverage_files(
        ...
        expected_result = [
            ...
            f"| [file\\_1.go]({pull_url}?src=pr&el=tree&filepath=file_1.go#diff-ZmlsZV8xLmdv) | 66.67% | [1 Missing :warning: ]({pull_url}?src=pr&el=tree) |",
            "",
            f"| [Files with reduced coverage]({pull_url}?dropdown=coverage&src=pr&el=tree) | Coverage Δ | Complexity Δ | |",
            "|---|---|---|---|",

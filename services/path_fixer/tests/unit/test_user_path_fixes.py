...
class TestUserPathFixes(BaseTestCase):
    ...
    def test_user_path_fixes_add_prefix_only(self):
        ...
        assert upf('added_prefix/second_path.java') == 'added_prefix/added_prefix/second_path.java'
    ...
    def test_user_path_fixes_remove_prefix_only(self):
        ...
        assert upf('thisisnot/prefix_to_remove/third_path.py') == 'thisisnot/prefix_to_remove/third_path.py'
    ...
    def test_user_path_fixes_remove_add_with_regex(self):
        ...
        assert upf('thisisnot/prefix_to_remove/test-third_path.py') == 'thisisnot/prefix_to_remove/test-third_path.py'

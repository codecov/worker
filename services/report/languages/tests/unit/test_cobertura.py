...
xml_with_source = """<?xml version="1.0" ?>
<!DOCTYPE coverage
  SYSTEM 'http://cobertura.sourceforge.net/xml/coverage-03.dtd'>
<coverage branch-rate="0.07143" line-rate="0.5506" timestamp="" version="3.7.1">
    <sources>
        <source>not to use</source>
    ...
    <packages>
        <package branch-rate="0.07143" complexity="0" line-rate="0.5506" name="">
            <classes>
                <class branch-rate="0.07143" complexity="0" filename="file_a" line-rate="0.5506" name="file">
                    <methods>
                        <method name="(anonymous_1)"  hits="1"  signature="()V" >
                            <lines><line number="undefined"  hits="1" /></lines>
                        </method>
...
class TestCobertura(BaseTestCase):
    ...
    def test_use_source_for_filename(self):
        processor = cobertura.CoberturaProcessor()
        report = cobertura.from_xml(
            etree.fromstring(xml_with_source),
            lambda path: path,
            {},
            0,
            {"codecov": {"max_report_age": None}},

...
class LegacyReportParser(object):
    ...
    def parse_raw_report_from_bytes(self, raw_report: bytes) -> LegacyParcedRawReport:
    ...
    def parse_raw_report_from_io(self, raw_report: BinaryIO) -> LegacyParcedRawReport:

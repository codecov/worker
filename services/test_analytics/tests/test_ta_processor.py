...
def test_ta_processor_impl_no_upload_id():
    ...
    result = ta_processor_impl(
        repository.repoid, commit.commitid, commit_yaml, argument
    )
...
@pytest.mark.django_db(databases=["default", "timeseries"])
def test_ta_processor_impl_already_processed():
    repository = RepositoryFactory.create()
    commit = CommitFactory.create(repository=repository, branch="main")
...
@pytest.mark.django_db(databases=["default", "timeseries"])
def test_ta_processor_impl_no_storage_path():
    repository = RepositoryFactory.create()
    commit = CommitFactory.create(repository=repository, branch="main")
...
@pytest.mark.django_db(databases=["default", "timeseries", "test_analytics"])

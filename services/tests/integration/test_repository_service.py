...
class TestRepositoryServiceIntegration(object):
    ...
    @pytest.mark.asyncio
    async def test_get_repo_provider_service_bitbucket(self, dbsession, mock_configuration, codecov_vcr):
    ...
    @pytest.mark.asyncio
    async def test_get_repo_provider_service_gitlab(self, dbsession, mock_configuration, codecov_vcr):
        mock_configuration.params['bitbucket'] = {
            'client_id': 'testzdcviyi3x7f8h0',
            'client_secret': 'testw35rwjj75gbaervbsmgl13vf39jd'
        }

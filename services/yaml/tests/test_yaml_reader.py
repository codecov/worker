...
class TestYamlReader(object):
    ...
    def test_round_number(self):
        ...
        assert Decimal('1.23457') == round_number(round_up_yaml_dict, Decimal('1.23456789'))
        assert Decimal('1.23457') == round_number(round_up_yaml_dict, Decimal('1.234565'))
        assert Decimal('1.23456') == round_number(round_up_yaml_dict, Decimal('1.234555'))
        round_down_yaml_dict = {'coverage': {'precision': 5, 'round': 'down'}}
        assert Decimal('1.23456') == round_number(round_down_yaml_dict, Decimal('1.23456789'))
        assert Decimal('1.23456') == round_number(round_down_yaml_dict, Decimal('1.234565'))
        assert Decimal('1.23455') == round_number(round_down_yaml_dict, Decimal('1.234555'))

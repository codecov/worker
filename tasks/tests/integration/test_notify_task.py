                    ...
                    "result": {
                        ...
                        "data_sent": {
                            "message": [
                                ...
                                "> Merging [#18](https://myexamplewebsite.io/gh/ThiagoCodecov/example-python/pull/18?src=pr&el=desc) (e999aac) into [master](https://myexamplewebsite.io/gh/ThiagoCodecov/example-python/commit/f0895290dc26668faeeb20ee5ccd4cc995925775?el=desc) (f089529) will **not change** coverage.",

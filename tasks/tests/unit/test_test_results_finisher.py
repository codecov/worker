...
class TestUploadTestFinisherTask(object):
    ...
    def test_upload_finisher_task_call_with_flaky(
        ...
        mock_repo_provider_comments.edit_comment.assert_called_with(
            pull.pullid,
            1,
            "**Test Failures Detected**: Due to failing tests, we cannot provide coverage reports at this time.\n\n### :x: Failed Test Results: \nCompleted 3 tests with **`3 failed`**(3 newly detected flaky), 0 passed and 0 skipped.\n- Total :snowflake:**3 flaky tests.**\n<details><summary>View the full list of failed tests</summary>\n\n| **Test Description** | **Failure message** |\n| :-- | :-- |\n| :snowflake::card_index_dividers: **Known Flaky Test**<br><pre>Testsuite:<br>test_testsuite2<br>Test name:<br>test_name<br>Envs:<br>- default<br></pre> | :snowflake: :card_index_dividers: **Failure on default branch**<br><pre>Shared failure message</pre> |\n| :snowflake::card_index_dividers: **Known Flaky Test**<br><pre>Testsuite:<br>test_testsuite<br>Test name:<br>test_name0<br>Envs:<br>- 0<br></pre> | :snowflake: :card_index_dividers: **Failure on default branch**<br><pre>&lt;pre&gt;Fourth <br><br>&lt;/pre&gt; | test  | instance |</pre> |\n| :snowflake::card_index_dividers: **Known Flaky Test**<br><pre>Testsuite:<br>test_testsuite<br>Test name:<br>test_name1<br>Envs:<br>- 1<br></pre> | :snowflake: :card_index_dividers: **Failure on default branch**<br><pre>Shared failure message</pre> |",
        )
